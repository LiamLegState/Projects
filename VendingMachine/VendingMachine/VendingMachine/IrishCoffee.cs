...
{
    class IrishCoffee : Beverage
    {
        List<string> _ingredients = new List<string>();

        public IrishCoffee(string beverageName, int beveragePrice, TextBlock tb, StringBuilder sb, params string[] ingredients) : base(beverageName, beveragePrice, tb, sb)
        {
        ...
        {
            sb.AppendLine("Adding irish coffee ingredients...");
            sb.AppendLine("");
