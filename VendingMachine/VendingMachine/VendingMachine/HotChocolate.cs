...
namespace VendingMachine
{
    class HotChocolate : Beverage
    {
        ...
        public HotChocolate(string beverageName, int beveragePrice, TextBlock tb, StringBuilder sb, params string[] ingredients) : base(beverageName, beveragePrice, tb, sb)
        {
        ...
        {
            sb.AppendLine("Adding hot chocolate ingredients...");
            sb.AppendLine("");
