...
namespace VendingMachine
{
    class Espresso : Beverage
    {
        ...
        public Espresso(string beverageName, int beveragePrice, TextBlock tb, StringBuilder sb, params string[] ingredients) : base(beverageName, beveragePrice, tb, sb)
        {
        ...
        {
            sb.AppendLine("Adding espresso ingredients...");
            sb.AppendLine("");
