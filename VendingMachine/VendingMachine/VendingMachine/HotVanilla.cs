...
{
    class HotVanilla : Beverage
    {
        List<string> _ingredients = new List<string>();

        public HotVanilla(string beverageName, int beveragePrice, TextBlock tb, StringBuilder sb, params string[] ingredients) : base(beverageName, beveragePrice, tb, sb)
        {
        ...
        {
            sb.AppendLine("Adding hot vanilla ingredients...");
            sb.AppendLine("");
